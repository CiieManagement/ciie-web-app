  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setFormData({
        ...
        branch: "",
        section: "",
        department: formData.department, // Keep department pre-filled
      });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">Apply for Community</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {formData.department === "Cloud" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-gray-700">Experience on Linux</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700">Shell Scripting</label>
                <input
                  type="text"
                  name="shellScripting"
              ...
              <div>
                <label className="block text-gray-700">GitHub Actions Experience</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700">Experience on Ansible</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700">Experience on Terraform</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700">Experience on Jira</label>
                <input
                  type="text"
                  name="jiraExperience"
              ...
              <div>
                <label className="block text-gray-700">Experience on Jenkins</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700">Experience on Docker</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700">Experience on Kubernetes</label>
                <input
                  type="text"
    ...
    <div>
      ...
      {formData.mlCourses === "Yes" && (
        <input
          ...
          onChange={handleChange}
          className="mt-2 w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600"
        />
      )}
    </div>

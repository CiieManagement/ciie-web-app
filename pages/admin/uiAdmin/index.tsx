...
const CommunityPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchCommunitiesAndApplications = async () => {
      try {
        ...
        const q = query(communitiesCollection, where('department', '==', 'Ui/Ux'));
        ...
        const w = query(applicationsCollection, where('department', '==', 'Ui/Ux'));
        ...
        const workshopQuery = query(workshopsCollection, where('department', '==', 'Ui/Ux'));
  ...
  const handleAddMember = async () => {
    try {
      ...
      const q = query(communitiesCollectionRef, where('department', '==', 'Ui/Ux'));
      ...
      if (!querySnapshot.empty) {
        ...
        console.error('No community found with department "Ui/Ux".');
      }
    } catch (error) {
  ...
  return isCoordinator ? (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-8">Ui/Ux Community Details</h1>
